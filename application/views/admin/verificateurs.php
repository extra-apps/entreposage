                ...
                <form id="f-add">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input name="nomverif" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Code du vérificateur</label>
                            <input name="codeverif" required class="form-control" value="<?= rand(10000, 99999) ?>">
                        </div>
                        <div class="form-group">
    ...
    <script>
        $(function() {
            ...
            function getdata() {
                ...
                $.getJSON('<?= site_url('json/verificateur_get') ?>', function(r) {
                    ...
                    $(r).each(function(i, e) {
                        ...
                        <td>${e.email}</td>
                        <td>
                            <button value="${e.idverificateur}" class="btn btn-outline-danger bdel" ><i class="fa fa-trash"></i></button>
                        </td>
                        </tr>
                        `;
                    });
            ...
            $('#f-del').submit(function() {
                ...
                rep.slideUp();
                $.ajax({
                    url: '<?= site_url('json/verificateur_del') ?>',
                    type: 'post',
                    data: data,
                    success: function(r) {
                        btn.find('span').removeClass();
